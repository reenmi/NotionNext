...
const BLOG = {
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 60, // 更新缓存间隔 单位(秒)；即每个页面有60秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也使文章更新有延迟。
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ruca', // 您的昵称 例如 tangly1024
  ...
  GREETING_WORDS:
    ...
    'Hi，我是Ruca,我喜欢科学和人文！,我们可以交流科学和人文方面的想法,同时也欢迎民科大咖和各位不同领域大咖前来光顾，一起来碰撞灵感🎉',
