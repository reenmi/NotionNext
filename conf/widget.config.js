...
module.exports = {
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      url: 'https://music.163.com/song/media/outer/url?id=2625425764.mp3',
      cover:
        'http://p2.music.126.net/k8LGUnmAVm4EdwDNMTlBlA==/109951169872323748.jpg'
    },
    {
      name: '王都グランセル',
      artist: 'Falcom Sound Team jdk',
    ...
    {
      name: 'To Build an Army',
      artist: 'Falcom Sound Team jdk',
      url: 'https://music.163.com/song/media/outer/url?id=1399524522.mp3',
      cover:
      'http://p2.music.126.net/7Ep6ozhBb-afXtZw68QTFA==/109951164452743481.jpg'
    }  ],
  MUSIC_PLAYER_METING: process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING || false, // 是否要开启 MetingJS，从平台获取歌单。会覆盖自定义的 MUSIC_PLAYER_AUDIO_LIST，更多配置信息：https://github.com/metowolf/MetingJS
  MUSIC_PLAYER_METING_SERVER:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_SERVER || 'netease', // 音乐平台，[netease, tencent, kugou, xiami, baidu]
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '2625425764', // 对应歌单的 id
